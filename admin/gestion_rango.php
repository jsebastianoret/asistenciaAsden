          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  <a href="gestion_rango.php" class="btn btn-primary btn-sm btn-flat">Gerencia</a>
              ...
              <?php include 'includes/gestion_rango-gerencia.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="gestion_rango.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="gestion_rango.php">
