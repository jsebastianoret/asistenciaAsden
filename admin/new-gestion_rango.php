        ...
        <div class="card">
          <div class="col-xs-12">
              ...
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  <a href="new-gestion_rango.php" class="btn btn-primary btn-sm btn-flat">Gerencia</a>
              ...
              <?php include 'includes/new-gestion_rango-gerencia.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="new-gestion_rango.php" style="display: inline-block;">
                          <input type="hidden" name="id" value="<?php echo $permiso["id"]; ?>">
                        </form>
                      </td>
                    </tr>

                    <div class="modal fade" id="editarModal<?php echo $permiso["id"]; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content rounded-3">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="new-gestion_rango.php">
