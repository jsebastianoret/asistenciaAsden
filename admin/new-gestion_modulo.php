          ...
          <div class="col-xs-12">
              ...
              <div class="box-header with-border gestion__seccion">
                <div class="button__gestion">
                  <a href="new-gestion_practicante.php" class="btn  btn-sm btn-flat">Gestionar lista de practicantes</a>
                  <a href="new-gestion_modulo.php" class="btn btn-primary btn-sm btn-flat">Otros módulos</a>
                </div>
                <div>
              ...
              <div class="box-body">
                <?php include 'includes/new-gestion_rango-modulo.php'; ?>
                    ...
                    <?php foreach ($permisos as $permiso) : ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form method="POST" action="new-gestion_modulo.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog modal-md" role="document">
                          ...
                          <div class="modal-header py-2">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="new-gestion_modulo.php">
