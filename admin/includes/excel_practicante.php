...
<?php header("content-Disposition: attachment; filename = Control de Asistencia NHL Practicante.xls") ?>
    ...
    <table border='1' id="example1 border-collapse: separate">
        ...
        <tbody>
            ...
            $sql = "SELECT attendance.*, employees.*, negocio.*, position.*, employees.employee_id AS empid,
                        ...
                        WHERE employees.employee_id = '$employee_id' AND YEAR(attendance.date) = $current_year AND WEEK(attendance.date) = $current_week
