...
if (isset($_POST['add'])) {
	...
	//
	$sql = "INSERT INTO employees (employee_id, firstname, lastname, contact_info, gender, departamento_id, negocio_id, position_id,
		 schedule_id, photo, created_on, date_in, date_out, time_practice, type_practice,birthday, dni, personal_email,
		 institutional_email,university,career) VALUES ('$employee_id', '$firstname', '$lastname', '$contact', '$gender', $departamento,
	...
	if ($conn->query($sql)) {
		$_SESSION['success'] = 'Practicante añadido con éxito';
	} else {
