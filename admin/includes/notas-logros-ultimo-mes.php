...
$sql_count_promedios = "SELECT COUNT(DISTINCT YEARWEEK(`fecha_inicio_semana`)) AS cantidad_promedios FROM `grades` WHERE `employee_id` = $employeeId";
$result_count_promedios = $conn->query($sql_count_promedios);
$row_count_promedios = $result_count_promedios->fetch_assoc();
$cantidadPromedios = $row_count_promedios["cantidad_promedios"];
