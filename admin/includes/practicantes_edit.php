...
if (isset($_POST['edit'])) {
	...
	$sql = "UPDATE employees SET firstname = '$firstname', lastname = '$lastname', contact_info = '$contact',
		 gender = '$gender', departamento_id = '$departamento', negocio_id = '$negocio', position_id = '$position', schedule_id = '$schedule' , date_in= '$date_in',
		 ...
		 WHERE id = '$empid'";
	if ($conn->query($sql)) {
		$_SESSION['success'] = 'Practicante actualizado con éxito';
	} else {
