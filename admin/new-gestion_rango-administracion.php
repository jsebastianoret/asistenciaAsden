          ...
          <div class="col-xs-12">
              ...
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  ...
                  <a href="new-gestion_rango-administracion.php" class="btn btn-primary btn-sm btn-flat">Administración de proyectos</a>
              ...
              <?php include 'includes/new-gestion_rango-administracion.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="new-gestion_rango-administracion.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog modal-md" role="document">
                            ...
                            <div class="modal-header py-2">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="new-gestion_rango-administracion.php">
