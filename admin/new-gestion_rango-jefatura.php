          ...
          <div class="col-xs-12">
              ...
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  ...
                  <a href="new-gestion_rango-jefatura.php" class="btn btn-primary btn-sm btn-flat">Jefatura de proyectos</a>
                  <a href="new-gestion_rango-unidad.php" class="btn btn-sm btn-flat">Unidad proyectos</a>
                </div>
              </div>
              <div class="box-body">

              <?php include 'includes/new-gestion_rango-jefatura.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="new-gestion_rango-jefatura.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog modal-md" role="document">
                            ...
                            <div class="modal-header py-2">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="new-gestion_rango-jefatura.php">
