...
<body class="bg-white">
   ...
   <div class="container-fluid" id="calendario-agenda">
      ...
      <div class="modal" tabindex="-1" role="dialog" id="eventoModalEdit">
            ...
            <div class="modal-content modal__calendar">
               <div class="modal-content modal__calendar">
                  <div class="modal-header" style="background-color: #54af0c; place-content: center;">
                     <h5 class="modal-title letraNavBar" style="color: white;"><b>Evento General</b></h5>
                     ...
                     <form action="includes/Editar-eliminar-actividades.php" method="post">
                        ...
                        <div class="contendModal-tf">
                           <div class="contendModal-tf1">
                              <h3 id="mensajeImagenModal" class="mensaje-imagen">No hay imagen para este evento</h3>
                              <img id="imagenModal2" src="" alt="imagen-evento" class="Imagen-evento-md">
                           </div>
                        ...
                        <div class="form-group letraNavBar">
                           <textarea readonly class="form-control detallesModal calendario-imput" name="detallesModal"
         ...
         <script src="../js/calendarioGeneral.js"></script>
