            ...
            <div class="box">
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  ...
                  <a href="gestion_rango-unidad.php" class="btn btn-primary btn-sm btn-flat">Unidad proyectos</a>
                </div>
              </div>
              <div class="box-body">

              <?php include 'includes/gestion_rango-unidad.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="gestion_rango-unidad.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="gestion_rango-unidad.php">
