            ...
            <div>
                ...
                <div class="statistics">
                    ...
                    if ($result_max_fecha_fin->num_rows > 0) {
                        ...
                        $sql1 = "SELECT * FROM grades WHERE employee_id = $employeeId AND fecha_fin_semana = '$ultima_fecha_fin' AND id_criterio = 1";
                        $result1 = $conn->query($sql1);
                        $sql2 = "SELECT * FROM grades WHERE employee_id = $employeeId AND fecha_fin_semana = '$ultima_fecha_fin' AND id_criterio = 2";
                        $result2 = $conn->query($sql2);
                        $sql3 = "SELECT * FROM grades WHERE employee_id = $employeeId AND fecha_fin_semana = '$ultima_fecha_fin' AND id_criterio = 3";
                    ...
                    <div class="weekly-summary">
                        <p class="summary-month letraNavBar">RESUMEN
                            <?php echo ucfirst($mes) ?> - SEMANA
                            <?php echo $cantidadPromedios ?>
                        </p>
                        <div class="grid">
