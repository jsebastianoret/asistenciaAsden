            ...
            <div class="box">
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  ...
                  <a href="gestion_rango-auxiliar.php" class="btn btn-primary btn-sm btn-flat">Auxiliar de gerencia</a>
              ...
              <?php include 'includes/gestion_rango-auxiliar.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="gestion_rango-auxiliar.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="gestion_rango-auxiliar.php">
