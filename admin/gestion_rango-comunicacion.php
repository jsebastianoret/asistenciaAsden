            ...
            <div class="box">
              <div class="box-header with-border gestion__seccion">
                ...
                <div>
                  ...
                  <a href="gestion_rango-comunicacion.php" class="btn btn-primary btn-sm btn-flat">Comunicacion interna</a>
              ...
              <?php include 'includes/gestion_rango-comunicacion.php'; ?>
                  ...
                  <?php foreach ($permisos as $permiso) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <form method="POST" action="gestion_rango-comunicacion.php" style="display: inline-block;">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="gestion_rango-comunicacion.php">
